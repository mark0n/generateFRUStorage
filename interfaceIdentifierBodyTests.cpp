...
{
  std::vector<std::string> body = boost::assign::list_of("123456")("1")("1")("1");
...
{
  std::vector<std::string> body = boost::assign::list_of("123456789012345678901234567890");
...
{
  std::vector<std::string> body = boost::assign::list_of("0234")("123456");
...
{
  std::vector<std::string> body = boost::assign::list_of("1234");
...
{
  std::vector<std::string> body = boost::assign::list_of("12345678")("01")("02")("0123");
  interfaceIdentifierBody iib( 1, body );
  std::vector<uint8_t> manResult = boost::assign::list_of(0x78)(0x56)(0x34)(0x12)(0x01)(0x02)(0x23)(0x01);
...
{
  std::vector<std::string> body = boost::assign::list_of("0123456789ABCDEF0000000000000000");
  interfaceIdentifierBody iib(2, body);
  std::vector<uint8_t> manResult = boost::assign::list_of(0x00)(0x00)(0x00)(0x00)(0x00)(0x00)(0x00)(0x00)(0xEF)(0xCD)(0xAB)(0x89)(0x67)(0x45)(0x23)(0x01);
  std::vector<uint8_t> autoResult = iib.getBinaryData();
  BOOST_CHECK_EQUAL_COLLECTIONS( autoResult.cbegin(), autoResult.cend(), manResult.cbegin(), manResult.cend() );
  if( autoResult != manResult )
  {
...
{
  std::vector<std::string> body = boost::assign::list_of("123456")("12345678");
  interfaceIdentifierBody iib(3, body);
  std::vector<uint8_t> manResult = boost::assign::list_of(0x56)(0x34)(0x12)(0x78)(0x56)(0x34)(0x12);
  std::vector<uint8_t> autoResult = iib.getBinaryData();
  BOOST_CHECK_EQUAL_COLLECTIONS( autoResult.cbegin(), autoResult.cend(), manResult.cbegin(), manResult.cend() );
  if( autoResult != manResult )
  {
...
{
  std::vector<std::string> body = boost::assign::list_of("12345678");
  interfaceIdentifierBody iib(4, body);
  std::vector<uint8_t> manResult = boost::assign::list_of(0x78)(0x56)(0x34)(0x12);
  std::vector<uint8_t> autoResult = iib.getBinaryData();
  BOOST_CHECK_EQUAL_COLLECTIONS( autoResult.cbegin(), autoResult.cend(), manResult.cbegin(), manResult.cend() );
  if( autoResult != manResult )
  {
